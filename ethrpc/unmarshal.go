...
func (tx *rpcTransaction) UnmarshalJSON(msg []byte) error {
	err := sonic.ConfigFastest.Unmarshal(msg, &tx.tx)
	if err != nil {
	...
	err = sonic.ConfigFastest.Unmarshal(msg, &tx.txExtraInfo)
	if err != nil {
		return err
	}
...
func IntoHeader(raw json.RawMessage, ret **types.Header, strictness StrictnessLevel) error {
	...
	if err := sonic.ConfigFastest.Unmarshal(raw, &header); err != nil {
		return err
	}
...
func IntoBlock(raw json.RawMessage, ret **types.Block, strictness StrictnessLevel) error {
	...
	if err := sonic.ConfigFastest.Unmarshal(raw, &head); err != nil {
		return err
	}
	if head == nil {
		return ethereum.NotFound
	}
	if err := sonic.ConfigFastest.Unmarshal(raw, &body); err != nil {
		return err
	}
...
func resetVRS(msg []byte) ([]byte, error) {
	...
	err := sonic.ConfigFastest.Unmarshal(msg, &m)
	if err != nil {
		return nil, err
	}
	m["v"] = "0x0"
	m["r"] = "0x0"
	m["s"] = "0x0"
	out, err := sonic.ConfigFastest.Marshal(m)
	if err != nil {
		return nil, err
	}
	return out, nil
