...
func TestGasGauge(t *testing.T) {
	...
	assert.Equal(t, "20647028442", suggestedGasPrice.InstantWei.String())
	assert.Equal(t, "20647028442", suggestedGasPrice.FastWei.String())
	assert.Equal(t, "20334528442", suggestedGasPrice.StandardWei.String())
	assert.Equal(t, "17284349175", suggestedGasPrice.SlowWei.String())
	assert.Equal(t, uint64(20), suggestedGasPrice.Instant)
	assert.Equal(t, uint64(20), suggestedGasPrice.Fast)
	assert.Equal(t, uint64(20), suggestedGasPrice.Standard)
	assert.Equal(t, uint64(17), suggestedGasPrice.Slow)
	assert.Equal(t, uint64(0xebe754), suggestedGasPrice.BlockNum.Uint64())
	assert.Equal(t, uint64(0x63122dcd), suggestedGasPrice.BlockTime)
}
