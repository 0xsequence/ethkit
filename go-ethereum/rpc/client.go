...
func (c *Client) CallContext(ctx context.Context, result interface{}, method string, args ...interface{}) error {
	...
	default:
		...
		return sonic.ConfigFastest.Unmarshal(resp.Result, result)
	}
}
...
func (c *Client) BatchCallContext(ctx context.Context, b []BatchElem) error {
	...
	for n := 0; n < len(batchresp); n++ {
		...
		default:
			elem.Error = sonic.ConfigFastest.Unmarshal(resp.Result, elem.Result)
		}
	}
...
func (c *Client) newMessage(method string, paramsIn ...interface{}) (*jsonrpcMessage, error) {
	...
	if paramsIn != nil { // prevent sending "params":null
		var err error
		if msg.Params, err = sonic.ConfigFastest.Marshal(paramsIn); err != nil {
			return nil, err
		}
	}
	return msg, nil
