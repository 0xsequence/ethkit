 ...
 *  ethkit_secp256k1_context_create for creation of contexts and
 *  ethkit_secp256k1_context_randomize for randomization.
 *
 ...
 *  ethkit_secp256k1_context_set_error_callback as well as
 *  ethkit_secp256k1_context_set_illegal_callback for details. Future library versions
 *  may use context objects for additional purposes.
 *
 *  A constructed context can safely be used from multiple threads
 *  simultaneously, but API calls that take a non-const pointer to a context
 *  need exclusive access to it. In particular this is the case for
 *  ethkit_secp256k1_context_destroy, secp256k1_context_preallocated_destroy,
 *  and ethkit_secp256k1_context_randomize.
 *
 ...
 *  use ethkit_secp256k1_ec_pubkey_serialize and ethkit_secp256k1_ec_pubkey_parse. To
 ...
 *  comparison, use the ethkit_secp256k1_ecdsa_signature_serialize_* and
 *  ethkit_secp256k1_ecdsa_signature_parse_* functions.
 */
typedef struct ethkit_secp256k1_ecdsa_signature {
    unsigned char data[64];
} ethkit_secp256k1_ecdsa_signature;
...
/** Context flags to pass to ethkit_secp256k1_context_create, secp256k1_context_preallocated_size, and
...
/** Flag to pass to ethkit_secp256k1_ec_pubkey_serialize. */
 ...
 *  it is mentioned in its documentation. See ethkit_secp256k1_context_create if you need a
 ...
 *  ethkit_secp256k1_context_create (or secp256k1_context_preallocated_create), which will
 *  take care of performing the self tests.
 *
 *  If the tests fail, this function will call the default error handler to abort the
 *  program (see ethkit_secp256k1_context_set_error_callback).
 */
 ...
 *  recommended to call ethkit_secp256k1_context_randomize on the context before calling
 *  those API functions. This will provide enhanced protection against side-channel
 *  leakage, see ethkit_secp256k1_context_randomize for details.
 *
 *  Do not create a new context object for each operation, as construction and
 *  randomization can take non-negligible time.
 */
SECP256K1_API secp256k1_context *ethkit_secp256k1_context_create(
    unsigned int flags
 ...
 */
SECP256K1_API secp256k1_context *ethkit_secp256k1_context_clone(
 ...
 *
 *  The context to destroy must have been created using ethkit_secp256k1_context_create
 *  or ethkit_secp256k1_context_clone. If the context has instead been created using
 *  secp256k1_context_preallocated_create or secp256k1_context_preallocated_clone, the
 *  behaviour is undefined. In that case, secp256k1_context_preallocated_destroy must
 *  be used instead.
 *
 *  Args:   ctx: pointer to a context to destroy, constructed using
 *               ethkit_secp256k1_context_create or ethkit_secp256k1_context_clone
 *               (i.e., not secp256k1_context_static).
 */
SECP256K1_API void ethkit_secp256k1_context_destroy(
 ...
 *  pointer could have been set using ethkit_secp256k1_context_set_illegal_callback or
 *  ethkit_secp256k1_context_set_error_callback, e.g., when the creation of a context
 ...
 *
 *  See also ethkit_secp256k1_context_set_error_callback.
 */
SECP256K1_API void ethkit_secp256k1_context_set_illegal_callback(
    secp256k1_context *ctx,
 ...
 *  incorrect usage of the API (see ethkit_secp256k1_context_set_illegal_callback
 ...
 *              default handler, see ethkit_secp256k1_context_set_illegal_callback
 *              for details).
 *        data: the opaque pointer to pass to fun above, must be NULL for the default handler.
 *
 *  See also ethkit_secp256k1_context_set_illegal_callback.
 */
SECP256K1_API void ethkit_secp256k1_context_set_error_callback(
    secp256k1_context *ctx,
    void (*fun)(const char *message, void *data),
    const void *data
) SECP256K1_ARG_NONNULL(1);
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int ethkit_secp256k1_ec_pubkey_parse(
    const secp256k1_context *ctx,
 ...
 */
SECP256K1_API int ethkit_secp256k1_ec_pubkey_serialize(
    const secp256k1_context *ctx,
 ...
 */
SECP256K1_API int ethkit_ethkit_secp256k1_ecdsa_signature_parse_compact(
    const secp256k1_context *ctx,
 ...
 */
SECP256K1_API int ethkit_ethkit_secp256k1_ecdsa_signature_parse_der(
    const secp256k1_context *ctx,
    ethkit_secp256k1_ecdsa_signature *sig,
    const unsigned char *input,
    size_t inputlen
 ...
 */
SECP256K1_API int ethkit_ethkit_secp256k1_ecdsa_signature_serialize_der(
    const secp256k1_context *ctx,
    unsigned char *output,
    size_t *outputlen,
    const ethkit_secp256k1_ecdsa_signature *sig
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3) SECP256K1_ARG_NONNULL(4);
 ...
 *  In:     sig:       pointer to an initialized signature object
 *
 *  See ethkit_ethkit_secp256k1_ecdsa_signature_parse_compact for details about the encoding.
 */
SECP256K1_API int ethkit_ethkit_secp256k1_ecdsa_signature_serialize_compact(
    const secp256k1_context *ctx,
 ...
 * rule, apply ethkit_ethkit_secp256k1_ecdsa_signature_normalize to the signature prior to
 * verification, but be aware that doing so results in malleable signatures.
 *
 * For details, see the comments for that function.
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int ethkit_secp256k1_ecdsa_verify(
    const secp256k1_context *ctx,
    const ethkit_secp256k1_ecdsa_signature *sig,
 ...
 *
 *  The ethkit_secp256k1_ecdsa_sign function will by default create signatures in the
 *  lower-S form, and ethkit_secp256k1_ecdsa_verify will not accept others. In case
 *  signatures come from a system that cannot enforce this property,
 *  ethkit_ethkit_secp256k1_ecdsa_signature_normalize must be called before verification.
 */
SECP256K1_API int ethkit_ethkit_secp256k1_ecdsa_signature_normalize(
    const secp256k1_context *ctx,
    ethkit_secp256k1_ecdsa_signature *sigout,
    const ethkit_secp256k1_ecdsa_signature *sigin
 ...
 * extra entropy.
 */
SECP256K1_API const secp256k1_nonce_function ethkit_secp256k1_nonce_function_rfc6979;

/** A default safe nonce generation function (currently equal to ethkit_secp256k1_nonce_function_rfc6979). */
SECP256K1_API const secp256k1_nonce_function ethkit_secp256k1_nonce_function_default;
 ...
 *                      ethkit_secp256k1_nonce_function_default is used.
 *           ndata:     pointer to arbitrary data used by the nonce generation function
 *                      (can be NULL). If it is non-NULL and
 *                      ethkit_secp256k1_nonce_function_default is used, then ndata must be a
 *                      pointer to 32-bytes of additional data.
 *
 * The created signature is always in lower-S form. See
 * ethkit_ethkit_secp256k1_ecdsa_signature_normalize for more details.
 */
SECP256K1_API int ethkit_secp256k1_ecdsa_sign(
    const secp256k1_context *ctx,
    ethkit_secp256k1_ecdsa_signature *sig,
    const unsigned char *msghash32,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int ethkit_secp256k1_ec_seckey_verify(
    const secp256k1_context *ctx,
    const unsigned char *seckey
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2);
 ...
 *  In:      seckey: pointer to a 32-byte secret key.
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int ethkit_secp256k1_ec_pubkey_create(
    const secp256k1_context *ctx,
    secp256k1_pubkey *pubkey,
    const unsigned char *seckey
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *           ethkit_secp256k1_ec_seckey_verify. 1 otherwise
 *  Args:   ctx:    pointer to a context object
 *  In/Out: seckey: pointer to the 32-byte secret key to be negated. If the
 *                  secret key is invalid according to
 *                  ethkit_secp256k1_ec_seckey_verify, this function returns 0 and
 ...
 *                  invalid according to ethkit_secp256k1_ec_seckey_verify, this
 ...
 *  future versions. */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int ethkit_secp256k1_ec_privkey_tweak_add(
    const secp256k1_context *ctx,
    unsigned char *seckey,
    const unsigned char *tweak32
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3)
 ...
 *                  negligible (around 1 in 2^128).
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int ethkit_secp256k1_ec_pubkey_tweak_add(
    const secp256k1_context *ctx,
    secp256k1_pubkey *pubkey,
    const unsigned char *tweak32
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *                  ethkit_secp256k1_ec_seckey_verify, this function returns 0. For
 ...
 *  future versions. */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int ethkit_secp256k1_ec_privkey_tweak_mul(
    const secp256k1_context *ctx,
    unsigned char *seckey,
    const unsigned char *tweak32
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3)
 ...
 *                  is negligible (around 1 in 2^128).
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int ethkit_secp256k1_ec_pubkey_tweak_mul(
    const secp256k1_context *ctx,
    secp256k1_pubkey *pubkey,
    const unsigned char *tweak32
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 * ethkit_secp256k1_context_create or ethkit_secp256k1_context_clone (or from the corresponding
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int ethkit_secp256k1_context_randomize(
    secp256k1_context *ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int ethkit_secp256k1_ec_pubkey_combine(
    const secp256k1_context *ctx,
