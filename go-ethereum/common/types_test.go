...
func TestHashJsonValidation(t *testing.T) {
	...
	for _, test := range tests {
		...
		var v Hash
		err := sonic.ConfigFastest.Unmarshal([]byte(input), &v)
		if err == nil {
			if test.Error != "" {
...
func TestAddressUnmarshalJSON(t *testing.T) {
	...
	for i, test := range tests {
		var v Address
		err := sonic.ConfigFastest.Unmarshal([]byte(test.Input), &v)
...
func TestMixedcaseAddressMarshal(t *testing.T) {
	...
	blob, err := sonic.ConfigFastest.Marshal(*addr)
	if err != nil {
		t.Fatal(err)
	}
	sonic.ConfigFastest.Unmarshal(blob, &output)
	if output != input {
...
func TestMixedcaseAccount_Address(t *testing.T) {
	...
	if err := sonic.ConfigFastest.Unmarshal([]byte(`[
	...
	for _, r := range []string{
		...
		if err := sonic.ConfigFastest.Unmarshal([]byte(r), &r2); err == nil {
...
func TestAddressEIP55(t *testing.T) {
	...
	var dec Address
	if err := sonic.ConfigFastest.Unmarshal(blob, &dec); err != nil {
