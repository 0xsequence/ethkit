...
// 	wallet, err := ethwallet.NewWallet("dose weasel clever culture letter volume endorse used harvest ripple circle install")
...
// func TestSignedTypedData(t *testing.T) {
// 	// EIP-712 Domain Hash
