...
func (c *Chain) BootstrapFromBlocksJSON(data []byte) error {
	var blocks Blocks
	err := sonic.Config.Unmarshal(data, &blocks)
	if err != nil {
...
func (c *Chain) Snapshot() ([]byte, error) {
	...
	data, err := sonic.Config.Marshal(c.blocks)
	if err != nil {
		return nil, err
	}
...
func (b *Block) MarshalJSON() ([]byte, error) {
	return sonic.Config.Marshal(&blockSnapshot{
		Block: b.Block,
		Event: b.Event,
		Logs:  b.Logs,
		OK:    b.OK,
...
func (b *Block) UnmarshalJSON(data []byte) error {
	var s *blockSnapshot
	err := sonic.Config.Unmarshal(data, &s)
	if err != nil {
		return err
	}
	b.Block = s.Block
