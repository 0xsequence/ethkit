...
func (c *Chain) BootstrapFromBlocksJSON(data []byte) error {
	var blocks Blocks
	err := sonic.ConfigFastest.Unmarshal(data, &blocks)
	if err != nil {
...
func (c *Chain) Snapshot() ([]byte, error) {
	...
	data, err := sonic.ConfigFastest.Marshal(c.blocks)
	if err != nil {
		return nil, err
	}
...
func (b *Block) MarshalJSON() ([]byte, error) {
	return sonic.ConfigFastest.Marshal(&blockSnapshot{
		Block: b.Block,
		Event: b.Event,
		Logs:  b.Logs,
		OK:    b.OK,
...
func (b *Block) UnmarshalJSON(data []byte) error {
	var s *blockSnapshot
	err := sonic.ConfigFastest.Unmarshal(data, &s)
	if err != nil {
		return err
	}
	b.Block = s.Block
